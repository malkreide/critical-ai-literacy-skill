...
[![Sprache: Deutsch (CH)](https://img.shields.io/badge/Sprache-Deutsch%20(CH)-red)](https://de.wikipedia.org/wiki/Schweizer_Hochdeutsch)
...
1. Lade `SKILL.md` aus diesem Repository herunter
2. Öffne Claude Desktop → Projects → Dein Projekt
3. Füge `SKILL.md` zur Wissensbasis des Projekts hinzu
4. Der Skill aktiviert sich automatisch bei relevanten Themen

### Direkter Einsatz

Kopiere den Inhalt von `SKILL.md` als Kontext in eine Claude-Konversation.
...
Weitere Beispiele im Ordner [`examples/`](examples/).

## Integration

Dieser Skill lässt sich gut kombinieren mit:

- **Use Cases SAM Workflow** — für die systematische Bewertung von KI-Anwendungsfällen
...
- Übersetzungen (Französisch, Italienisch, Englisch)
